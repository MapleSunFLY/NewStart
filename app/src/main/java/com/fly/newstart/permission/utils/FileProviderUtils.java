package com.fly.newstart.permission.utils;
 ...
 *    (______|______)
 * </pre>
 * 包    名 : com.fly.newstart.permission.Utils
 * 作    者 : FLY
 * 创建时间 : 2019/4/8
 * 描述:从APP向外共享的文件URI时，必须使用该类进行适配，否则在7.0以上系统，会报错：FileUriExposedException(文件Uri暴露异常)
 */
